...
//    let store_ids: String?    // "70300609;70300144;70400343"
//
//    var id: Int { productId }
//
//    // MARK: - Price helpers
//
//    /// All prices parsed into an array, index-aligned with storeIdList
...
//    }
//
//    /// All store IDs parsed into an array, index-aligned with priceList
...
//    }
//
//    /// Price at a specific store ID — returns nil if store doesn't carry this item
...
//    }
//
//    /// Display price — uses store-specific price if a store is selected, else min
...
extension AuthManager {
    ...
    func fetchKrogerItems(
        ...
        if let s = search?.trimmingCharacters(in: .whitespacesAndNewlines), !s.isEmpty {
            // Search both name AND search_keyword so "apple" matches
            // "Fuji Apple – Each" (name) AND products with search_keyword="apple"
            // PostgREST OR syntax: ?or=(name.ilike.*term*,search_keyword.ilike.*term*)
